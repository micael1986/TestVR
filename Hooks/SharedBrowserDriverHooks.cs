...
namespace TestVR.Hooks
{
  ...
  public class SharedBrowserHooks
  {
    ...
    [AfterFeature]
    public static void After(ObjectContainer testThreadContainer)
    {
      //Close a shared BrowserDriver in the global container
      testThreadContainer.BaseContainer.Resolve<BrowserDriver>().Dispose();
    }
  }
}
